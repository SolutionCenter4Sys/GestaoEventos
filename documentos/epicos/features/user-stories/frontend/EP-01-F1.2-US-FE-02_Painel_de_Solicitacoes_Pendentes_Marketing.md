# User Story – Frontend | Painel de Solicitações Pendentes (Marketing)

**Épico:** EP-01 – Gestão de Solicitações e Aprovação de Eventos  
**Feature:** EP-01-F1.2 – Workflow de Aprovação  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-01-F1.2-US-FE-02 |
| **Título** | Painel de Solicitações Pendentes (Marketing) |
| **Épico** | EP-01 – Gestão de Solicitações e Aprovação de Eventos |
| **Feature** | EP-01-F1.2 – Workflow de Aprovação |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-01, US-BE-03, US-BE-04 |
| **Status** | Proposta |
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 3 | M |
...
### Dependências:
- **API Backend:** US-BE-01, US-BE-03, US-BE-04
