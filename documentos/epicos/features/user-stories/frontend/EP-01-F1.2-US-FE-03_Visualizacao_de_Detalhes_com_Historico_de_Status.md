# User Story – Frontend | Visualização de Detalhes com Histórico de Status
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-01-F1.2-US-FE-03 |
| **Título** | Visualização de Detalhes com Histórico de Status |
| **Épico** | EP-01 – Gestão de Solicitações e Aprovação de Eventos |
| **Feature** | EP-01-F1.2 – Workflow de Aprovação |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-01, US-BE-05 |
| **Status** | Proposta |
