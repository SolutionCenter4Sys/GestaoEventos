# User Story – Frontend | Mencionar Usuários com @
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-01-F1.3-US-FE-03 |
| **Título** | Mencionar Usuários com @ |
| **Épico** | EP-01 – Gestão de Solicitações e Aprovação de Eventos |
| **Feature** | EP-01-F1.3 – Comunicação Vendas-Marketing |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-01, US-BE-04 |
| **Status** | Proposta |
