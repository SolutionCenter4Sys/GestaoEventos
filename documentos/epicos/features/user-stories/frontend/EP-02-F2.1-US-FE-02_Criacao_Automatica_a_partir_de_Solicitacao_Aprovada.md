# User Story – Frontend | Criação Automática a partir de Solicitação Aprovada
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-02-F2.1-US-FE-02 |
| **Título** | Criação Automática a partir de Solicitação Aprovada |
| **Épico** | EP-02 – Gestão e Publicação de Eventos |
| **Feature** | EP-02-F2.1 – CRUD de Eventos |
...
Esta US de frontend cobre 1 - Botão na tela de solicitação aprovada + formulário pré-preenchido - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Botão na tela de solicitação aprovada + formulário pré-preenchido - M | M |
