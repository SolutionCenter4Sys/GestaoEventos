# User Story – Frontend | Lista de Eventos e Ações (Visualizar/Editar/Duplicar/Arquivar)
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-02-F2.1-US-FE-03 |
| **Título** | Lista de Eventos e Ações (Visualizar/Editar/Duplicar/Arquivar) |
| **Épico** | EP-02 – Gestão e Publicação de Eventos |
| **Feature** | EP-02-F2.1 – CRUD de Eventos |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-04, US-BE-05 |
| **Status** | Proposta |
...
Esta US de frontend cobre 2 - Lista de eventos (tabela com filtros) + Modal de confirmação de exclusão - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Lista de eventos (tabela com filtros) + Modal de confirmação de exclusão - M | M |
