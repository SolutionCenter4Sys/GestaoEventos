# User Story – Frontend | Bloqueio de Inscrição Quando Esgotado

**Épico:** EP-02 – Gestão e Publicação de Eventos  
**Feature:** EP-02-F2.2 – Controle de Capacidade e Vagas  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-02-F2.2-US-FE-02 |
| **Título** | Bloqueio de Inscrição Quando Esgotado |
| **Épico** | EP-02 – Gestão e Publicação de Eventos |
| **Feature** | EP-02-F2.2 – Controle de Capacidade e Vagas |
