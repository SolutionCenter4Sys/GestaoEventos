# User Story – Frontend | Meus Eventos (Abas: Próximos, Concluídos, Lista Espera)
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-03-F3.2-US-FE-02 |
| **Título** | Meus Eventos (Abas: Próximos, Concluídos, Lista Espera) |
| **Épico** | EP-03 – Inscrições e Área do Participante |
| **Feature** | EP-03-F3.2 – EP-03-F3.2 |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-02 |
| **Status** | Proposta |
