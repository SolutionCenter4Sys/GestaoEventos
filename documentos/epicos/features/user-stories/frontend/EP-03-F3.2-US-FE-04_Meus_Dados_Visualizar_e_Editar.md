# User Story – Frontend | Meus Dados (Visualizar e Editar)

**Épico:** EP-03 – Inscrições e Área do Participante  
**Feature:** EP-03-F3.2 – EP-03-F3.2  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-03-F3.2-US-FE-04 |
| **Título** | Meus Dados (Visualizar e Editar) |
| **Épico** | EP-03 – Inscrições e Área do Participante |
| **Feature** | EP-03-F3.2 – EP-03-F3.2 |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-04 |
| **Status** | Proposta |
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 | M |
...
### Pendências / Gaps Identificados (Matriz US vs Código):

> **Fonte:** MATRIZ_COMPARACAO_CAMPOS_US_VS_CODIGO.md – 11/02/2026

| Item | Status | Descrição |
|------|--------|-----------|
| **novaSenha – minLength** | ⚠️ Parcial | US recomenda minLength(8) para senha; código implementa minLength(6) – alinhar com padrão de segurança (8 caracteres) |
