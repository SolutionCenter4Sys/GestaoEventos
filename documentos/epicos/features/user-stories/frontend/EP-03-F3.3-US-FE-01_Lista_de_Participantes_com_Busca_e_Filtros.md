# User Story – Frontend | Lista de Participantes com Busca e Filtros
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-03-F3.3-US-FE-01 |
| **Título** | Lista de Participantes com Busca e Filtros |
| **Épico** | EP-03 – Inscrições e Área do Participante |
| **Feature** | EP-03-F3.3 – EP-03-F3.3 |
