# User Story – Frontend | Importação e Exportação de Participantes

**Épico:** EP-03 – Inscrições e Área do Participante  
**Feature:** EP-03-F3.3 – EP-03-F3.3  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-03-F3.3-US-FE-03 |
| **Título** | Importação e Exportação de Participantes |
| **Épico** | EP-03 – Inscrições e Área do Participante |
| **Feature** | EP-03-F3.3 – EP-03-F3.3 |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-03, US-BE-04 |
| **Status** | Proposta |
