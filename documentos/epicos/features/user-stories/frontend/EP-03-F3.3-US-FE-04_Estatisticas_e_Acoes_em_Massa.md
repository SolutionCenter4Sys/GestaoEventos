# User Story – Frontend | Estatísticas e Ações em Massa
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-03-F3.3-US-FE-04 |
| **Título** | Estatísticas e Ações em Massa |
| **Épico** | EP-03 – Inscrições e Área do Participante |
| **Feature** | EP-03-F3.3 – EP-03-F3.3 |
| **Produto / Iniciativa** | Plataforma Web Unificada de Gestão de Eventos |
| **Relacionada a (Backend)** | US-BE-05 |
| **Status** | Proposta |
