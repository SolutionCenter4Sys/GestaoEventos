# User Story – Frontend | Visualização de Certificados Gerados por Evento
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-04-F4.1-US-FE-02 |
| **Título** | Visualização de Certificados Gerados por Evento |
| **Épico** | EP-04 – Sistema de Certificação |
| **Feature** | EP-04-F4.1 – Geração de Certificados |
...
Esta US de frontend cobre 1 - Aba "Certificados" na tela de evento (lista com participantes, status, ações) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Aba "Certificados" na tela de evento (lista com participantes, status, ações) - M | M |
