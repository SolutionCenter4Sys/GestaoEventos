# User Story – Frontend | Regeneração Individual de Certificado
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-04-F4.1-US-FE-03 |
| **Título** | Regeneração Individual de Certificado |
| **Épico** | EP-04 – Sistema de Certificação |
| **Feature** | EP-04-F4.1 – Geração de Certificados |
...
Esta US de frontend cobre 1 - Botão "Regenerar" na lista de certificados + modal de confirmação - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Botão "Regenerar" na lista de certificados + modal de confirmação - P | M |
