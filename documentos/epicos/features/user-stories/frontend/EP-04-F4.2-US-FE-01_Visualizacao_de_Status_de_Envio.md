# User Story – Frontend | Visualização de Status de Envio

**Épico:** EP-04 – Sistema de Certificação  
**Feature:** EP-04-F4.2 – Envio Automático de Certificados  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-04-F4.2-US-FE-01 |
| **Título** | Visualização de Status de Envio |
| **Épico** | EP-04 – Sistema de Certificação |
| **Feature** | EP-04-F4.2 – Envio Automático de Certificados |
...
Esta US de frontend cobre 1 - Coluna "Status Envio" na lista de certificados (badge colorido) - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Coluna "Status Envio" na lista de certificados (badge colorido) - P | M |
