# User Story – Frontend | Reenvio Individual e em Massa
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-04-F4.3-US-FE-01 |
| **Título** | Reenvio Individual e em Massa |
| **Épico** | EP-04 – Sistema de Certificação |
| **Feature** | EP-04-F4.3 – Reenvio e Auditoria de Certificados |
...
Esta US de frontend cobre 2 - Botão "Reenviar" + modal de confirmação em massa - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Botão "Reenviar" + modal de confirmação em massa - M | M |
