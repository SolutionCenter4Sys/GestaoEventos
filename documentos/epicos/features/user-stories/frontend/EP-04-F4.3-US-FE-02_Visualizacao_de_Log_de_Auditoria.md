# User Story – Frontend | Visualização de Log de Auditoria

**Épico:** EP-04 – Sistema de Certificação  
**Feature:** EP-04-F4.3 – Reenvio e Auditoria de Certificados  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-04-F4.3-US-FE-02 |
| **Título** | Visualização de Log de Auditoria |
| **Épico** | EP-04 – Sistema de Certificação |
| **Feature** | EP-04-F4.3 – Reenvio e Auditoria de Certificados |
...
Esta US de frontend cobre 1 - Página de auditoria (tabela com logs, filtros, busca) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Página de auditoria (tabela com logs, filtros, busca) - M | M |
