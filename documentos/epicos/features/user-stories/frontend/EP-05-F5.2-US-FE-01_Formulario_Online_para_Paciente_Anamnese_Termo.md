# User Story – Frontend | Formulário Online para Paciente (Anamnese + Termo)

**Épico:** EP-05 – Documentos de Paciente  
**Feature:** EP-05-F5.2 – EP-05-F5.2  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.2-US-FE-01 |
| **Título** | Formulário Online para Paciente (Anamnese + Termo) |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.2 – EP-05-F5.2 |
...
Esta US de frontend cobre 2 - Formulário de anamnese (~20 campos) + Termo com assinatura eletrônica - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Formulário de anamnese (~20 campos) + Termo com assinatura eletrônica - G | M |
