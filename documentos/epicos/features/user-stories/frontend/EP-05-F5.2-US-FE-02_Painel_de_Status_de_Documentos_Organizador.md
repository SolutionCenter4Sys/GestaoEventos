# User Story – Frontend | Painel de Status de Documentos (Organizador)
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.2-US-FE-02 |
| **Título** | Painel de Status de Documentos (Organizador) |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.2 – EP-05-F5.2 |
...
Esta US de frontend cobre 1 - Tabela com pacientes, status docs (badges), ações (Reenviar, Aprovar) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Tabela com pacientes, status docs (badges), ações (Reenviar, Aprovar) - M | M |
