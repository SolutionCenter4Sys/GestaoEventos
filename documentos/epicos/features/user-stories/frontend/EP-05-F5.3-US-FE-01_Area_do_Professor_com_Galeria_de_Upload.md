# User Story – Frontend | Área do Professor com Galeria de Upload

**Épico:** EP-05 – Documentos de Paciente  
**Feature:** EP-05-F5.3 – EP-05-F5.3  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.3-US-FE-01 |
| **Título** | Área do Professor com Galeria de Upload |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.3 – EP-05-F5.3 |
...
Esta US de frontend cobre 2 - Lista de eventos do professor + Galeria de fotos por paciente com upload - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Lista de eventos do professor + Galeria de fotos por paciente com upload - G | M |
