# User Story – Frontend | Galeria Antes/Depois
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.3-US-FE-02 |
| **Título** | Galeria Antes/Depois |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.3 – EP-05-F5.3 |
...
Esta US de frontend cobre 1 - Galeria com fotos em grid, separação antes/depois - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Galeria com fotos em grid, separação antes/depois - M | M |
