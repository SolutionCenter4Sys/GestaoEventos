# User Story – Frontend | Dashboard de Completude de Documentação

**Épico:** EP-05 – Documentos de Paciente  
**Feature:** EP-05-F5.4 – EP-05-F5.4  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.4-US-FE-01 |
| **Título** | Dashboard de Completude de Documentação |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.4 – EP-05-F5.4 |
...
Esta US de frontend cobre 1 - Dashboard com % completude, lista pacientes pendentes, alertas - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Dashboard com % completude, lista pacientes pendentes, alertas - M | M |
