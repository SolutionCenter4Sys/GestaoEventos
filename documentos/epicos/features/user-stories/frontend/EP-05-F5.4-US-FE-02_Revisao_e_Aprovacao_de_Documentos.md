# User Story – Frontend | Revisão e Aprovação de Documentos
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-05-F5.4-US-FE-02 |
| **Título** | Revisão e Aprovação de Documentos |
| **Épico** | EP-05 – Documentos de Paciente |
| **Feature** | EP-05-F5.4 – EP-05-F5.4 |
...
Esta US de frontend cobre 2 - Visualização de documentos + Modal de aprovação/reprovação - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Visualização de documentos + Modal de aprovação/reprovação - M | M |
