# User Story – Frontend | Editor de Templates

**Épico:** EP-06 – Templates e Comunicação por E-mail  
**Feature:** EP-06-F6.1 – EP-06-F6.1  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-06-F6.1-US-FE-01 |
| **Título** | Editor de Templates |
| **Épico** | EP-06 – Templates e Comunicação por E-mail |
| **Feature** | EP-06-F6.1 – EP-06-F6.1 |
...
Esta US de frontend cobre 1 - Editor com painel lateral (variáveis), área de edição, preview side-by-side - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Editor com painel lateral (variáveis), área de edição, preview side-by-side - G | M |
