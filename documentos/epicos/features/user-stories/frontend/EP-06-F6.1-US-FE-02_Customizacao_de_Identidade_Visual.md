# User Story – Frontend | Customização de Identidade Visual
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-06-F6.1-US-FE-02 |
| **Título** | Customização de Identidade Visual |
| **Épico** | EP-06 – Templates e Comunicação por E-mail |
| **Feature** | EP-06-F6.1 – EP-06-F6.1 |
...
Esta US de frontend cobre 1 - Painel de configuração visual com upload e color pickers - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Painel de configuração visual com upload e color pickers - M | M |
