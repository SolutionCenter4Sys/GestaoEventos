# User Story – Frontend | Interface de Consulta de Log

**Épico:** EP-06 – Templates e Comunicação por E-mail  
**Feature:** EP-06-F6.3 – EP-06-F6.3  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-06-F6.3-US-FE-01 |
| **Título** | Interface de Consulta de Log |
| **Épico** | EP-06 – Templates e Comunicação por E-mail |
| **Feature** | EP-06-F6.3 – EP-06-F6.3 |
...
Esta US de frontend cobre 1 - Tabela com log (destinatário, assunto, data, status), busca, filtros, exportação - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Tabela com log (destinatário, assunto, data, status), busca, filtros, exportação - M | M |
