# User Story – Frontend | Relatório de Deliverability
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-06-F6.3-US-FE-02 |
| **Título** | Relatório de Deliverability |
| **Épico** | EP-06 – Templates e Comunicação por E-mail |
| **Feature** | EP-06-F6.3 – EP-06-F6.3 |
...
Esta US de frontend cobre 1 - Dashboard com KPIs e gráficos (linha temporal, pizza de status) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Dashboard com KPIs e gráficos (linha temporal, pizza de status) - M | M |
