# User Story – Frontend | Configuração de Integração

**Épico:** EP-07 – Integração Outlook  
**Feature:** EP-07-F7.1 – EP-07-F7.1  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-07-F7.1-US-FE-01 |
| **Título** | Configuração de Integração |
| **Épico** | EP-07 – Integração Outlook |
| **Feature** | EP-07-F7.1 – EP-07-F7.1 |
...
Esta US de frontend cobre 1 - Página de configuração com botão "Conectar com Microsoft" - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Página de configuração com botão "Conectar com Microsoft" - M | M |
