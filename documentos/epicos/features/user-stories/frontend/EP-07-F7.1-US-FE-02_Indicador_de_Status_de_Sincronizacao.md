# User Story – Frontend | Indicador de Status de Sincronização
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-07-F7.1-US-FE-02 |
| **Título** | Indicador de Status de Sincronização |
| **Épico** | EP-07 – Integração Outlook |
| **Feature** | EP-07-F7.1 – EP-07-F7.1 |
...
Esta US de frontend cobre 1 - Badge de status na lista de eventos - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Badge de status na lista de eventos - P | M |
