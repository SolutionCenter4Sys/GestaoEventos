# User Story – Frontend | Seleção de Fuso Horário
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-07-F7.3-US-FE-01 |
| **Título** | Seleção de Fuso Horário |
| **Épico** | EP-07 – Integração Outlook |
| **Feature** | EP-07-F7.3 – EP-07-F7.3 |
...
Esta US de frontend cobre 1 - Campo dropdown com time zones (ex: America/Sao_Paulo) - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Campo dropdown com time zones (ex: America/Sao_Paulo) - P | M |
