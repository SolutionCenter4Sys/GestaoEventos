# User Story – Frontend | Exibição com Fuso do Evento

**Épico:** EP-07 – Integração Outlook  
**Feature:** EP-07-F7.3 – EP-07-F7.3  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-07-F7.3-US-FE-02 |
| **Título** | Exibição com Fuso do Evento |
| **Épico** | EP-07 – Integração Outlook |
| **Feature** | EP-07-F7.3 – EP-07-F7.3 |
...
Esta US de frontend cobre 1 - Label indicando fuso (ex: "18:00 (Horário de Brasília)") - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Label indicando fuso (ex: "18:00 (Horário de Brasília)") - P | M |
