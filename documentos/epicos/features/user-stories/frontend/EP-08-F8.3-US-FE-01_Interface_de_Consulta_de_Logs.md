# User Story – Frontend | Interface de Consulta de Logs

**Épico:** EP-08 – Autenticação e Conformidade LGPD  
**Feature:** EP-08-F8.3 – EP-08-F8.3  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-08-F8.3-US-FE-01 |
| **Título** | Interface de Consulta de Logs |
| **Épico** | EP-08 – Autenticação e Conformidade LGPD |
| **Feature** | EP-08-F8.3 – EP-08-F8.3 |
...
Esta US de frontend cobre 1 - Tabela de logs com filtros, busca, exportação, detalhes expandíveis - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Tabela de logs com filtros, busca, exportação, detalhes expandíveis - G | M |
