# User Story – Frontend | Relatório de Compliance
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-08-F8.3-US-FE-02 |
| **Título** | Relatório de Compliance |
| **Épico** | EP-08 – Autenticação e Conformidade LGPD |
| **Feature** | EP-08-F8.3 – EP-08-F8.3 |
...
Esta US de frontend cobre 1 - Formulário de geração de relatório (período, módulos) + download - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Formulário de geração de relatório (período, módulos) + download - M | M |
