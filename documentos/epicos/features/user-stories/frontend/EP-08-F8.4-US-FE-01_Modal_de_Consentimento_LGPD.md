# User Story – Frontend | Modal de Consentimento LGPD
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-08-F8.4-US-FE-01 |
| **Título** | Modal de Consentimento LGPD |
| **Épico** | EP-08 – Autenticação e Conformidade LGPD |
| **Feature** | EP-08-F8.4 – EP-08-F8.4 |
...
Esta US de frontend cobre 1 - Modal com termo completo, checkbox "Aceito", não pode fechar sem aceitar - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Modal com termo completo, checkbox "Aceito", não pode fechar sem aceitar - M | M |
