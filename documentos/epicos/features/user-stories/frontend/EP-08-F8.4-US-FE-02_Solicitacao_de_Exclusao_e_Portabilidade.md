# User Story – Frontend | Solicitação de Exclusão e Portabilidade

**Épico:** EP-08 – Autenticação e Conformidade LGPD  
**Feature:** EP-08-F8.4 – EP-08-F8.4  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-08-F8.4-US-FE-02 |
| **Título** | Solicitação de Exclusão e Portabilidade |
| **Épico** | EP-08 – Autenticação e Conformidade LGPD |
| **Feature** | EP-08-F8.4 – EP-08-F8.4 |
...
Esta US de frontend cobre 2 - Página "Meus Dados e Privacidade" com botões "Solicitar Exclusão" e "Exportar Dados" - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 2 - Página "Meus Dados e Privacidade" com botões "Solicitar Exclusão" e "Exportar Dados" - M | M |
