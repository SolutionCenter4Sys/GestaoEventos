# User Story – Frontend | Gestão de Solicitações LGPD (Admin)
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-08-F8.4-US-FE-03 |
| **Título** | Gestão de Solicitações LGPD (Admin) |
| **Épico** | EP-08 – Autenticação e Conformidade LGPD |
| **Feature** | EP-08-F8.4 – EP-08-F8.4 |
...
Esta US de frontend cobre 1 - Painel de solicitações LGPD pendentes - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Painel de solicitações LGPD pendentes - M | M |
