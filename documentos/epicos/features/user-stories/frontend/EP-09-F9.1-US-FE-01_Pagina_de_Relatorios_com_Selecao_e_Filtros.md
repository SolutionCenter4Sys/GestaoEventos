# User Story – Frontend | Página de Relatórios com Seleção e Filtros

**Épico:** EP-09 – Relatórios e Exportações  
**Feature:** EP-09-F9.1 – Relatórios Operacionais  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.1-US-FE-01 |
| **Título** | Página de Relatórios com Seleção e Filtros |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.1 – Relatórios Operacionais |
...
Esta US de frontend cobre 1 - Página com dropdown de relatórios, filtros dinâmicos, botões "Gerar CSV/PDF" - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Página com dropdown de relatórios, filtros dinâmicos, botões "Gerar CSV/PDF" - G | M |
