# User Story – Frontend | Configuração de Relatórios Agendados
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.1-US-FE-02 |
| **Título** | Configuração de Relatórios Agendados |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.1 – Relatórios Operacionais |
...
Esta US de frontend cobre 1 - Formulário de agendamento (tipo, cron expression, e-mails) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Formulário de agendamento (tipo, cron expression, e-mails) - M | M |
