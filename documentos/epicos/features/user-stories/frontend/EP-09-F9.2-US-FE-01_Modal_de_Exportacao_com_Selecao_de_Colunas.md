# User Story – Frontend | Modal de Exportação com Seleção de Colunas

**Épico:** EP-09 – Relatórios e Exportações  
**Feature:** EP-09-F9.2 – Exportação de Dados  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.2-US-FE-01 |
| **Título** | Modal de Exportação com Seleção de Colunas |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.2 – Exportação de Dados |
...
Esta US de frontend cobre 1 - Modal com checkboxes de colunas, dropdown de formato, botão "Exportar" - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Modal com checkboxes de colunas, dropdown de formato, botão "Exportar" - M | M |
