# User Story – Frontend | Download de Exportações
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.2-US-FE-02 |
| **Título** | Download de Exportações |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.2 – Exportação de Dados |
...
Esta US de frontend cobre 1 - Spinner com progresso ou notificação "Será enviado por e-mail" - P.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Spinner com progresso ou notificação "Será enviado por e-mail" - P | M |
