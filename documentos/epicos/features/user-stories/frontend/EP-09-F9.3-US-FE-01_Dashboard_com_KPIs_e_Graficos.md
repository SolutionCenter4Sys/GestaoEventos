# User Story – Frontend | Dashboard com KPIs e Gráficos

**Épico:** EP-09 – Relatórios e Exportações  
**Feature:** EP-09-F9.3 – Dashboard Gerencial  
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.3-US-FE-01 |
| **Título** | Dashboard com KPIs e Gráficos |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.3 – Dashboard Gerencial |
...
Esta US de frontend cobre 1 - Dashboard com cards de KPIs, 4-6 gráficos, filtros de período - G.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Dashboard com cards de KPIs, 4-6 gráficos, filtros de período - G | M |
