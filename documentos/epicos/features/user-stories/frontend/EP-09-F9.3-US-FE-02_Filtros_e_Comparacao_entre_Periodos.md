# User Story – Frontend | Filtros e Comparação entre Períodos
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.3-US-FE-02 |
| **Título** | Filtros e Comparação entre Períodos |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.3 – Dashboard Gerencial |
...
Esta US de frontend cobre 1 - Filtros avançados (date range picker, comparação) - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Filtros avançados (date range picker, comparação) - M | M |
