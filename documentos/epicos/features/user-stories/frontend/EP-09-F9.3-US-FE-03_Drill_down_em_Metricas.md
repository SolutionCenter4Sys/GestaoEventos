# User Story – Frontend | Drill-down em Métricas
...
| Campo | Conteúdo |
|-------|----------|
| **ID da US** | EP-09-F9.3-US-FE-03 |
| **Título** | Drill-down em Métricas |
| **Épico** | EP-09 – Relatórios e Exportações |
| **Feature** | EP-09-F9.3 – Dashboard Gerencial |
...
Esta US de frontend cobre 1 - Modal ou página com lista filtrada conforme métrica clicada - M.
...
|-------------------|------|-----------------|-----------------|
| Componente principal | Component | 1 - Modal ou página com lista filtrada conforme métrica clicada - M | M |
